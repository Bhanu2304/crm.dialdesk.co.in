...
$stmt="SELECT count(*) from vicidial_list where lead_id='" . mysqli_real_escape_string($link, $lead_id) . "'";
  ...
  if($_POST['SUBMIT']){
    ...
    */
    ...
    $qry_columns['CallerId'] = $phone_number;
    ...
    $lead_status = addslashes($_POST['lead_status']);
    $lead_source = addslashes($_POST['lead_source']);
    $lead_type = addslashes($_POST['lead_type']);
    $lead_priority = addslashes($_POST['lead_priority']);
    $followup_date = addslashes($_POST['followup_date']);
    
     $str_insert = "insert into call_master($columns_str,lead_status,lead_source,lead_type,followup_date,lead_priority,created_at) values ('$column_values_str','$lead_status','$lead_source','$lead_type','$followup_date','$lead_priority',NOW())";
...
//$postdata;
  ...
  header("location: call_screen_phone.php");
