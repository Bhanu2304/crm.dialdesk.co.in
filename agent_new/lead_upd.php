...
if(isset($_POST['SUBMIT']))
{
  ...
  if($subStatus !== "All") {
      $Whrqry .= " AND subStatus='$subStatus'";
  }
...
$selectQuery = "SELECT * FROM hopper_data where agentId='".$_SESSION['SESS_USER']."' and allocationName='$allocationName' $Whrqry";
...
<html dir="ltr" lang="en">
 ...
 <script>
    function fetchAndDisplayResults() { alert("zddas");
    var param1Value = $('#output').val();
                          ...
                          <tr>
                            ...
                            <tbody>
                                ...
                                { //print_r($row);
                                    ...
                                    echo "<tr>";
                                    echo "<td><a href=\"#\" onClick=\"fetchAndDisplayResults()\" />{$row['phoneNumber']} </a><input type=\"hidden\" name=\"output\" id=\"output\" value=\"{$row['phoneNumber']}\"></td>";
                                    echo "<td>{$row['name']}</td>";
