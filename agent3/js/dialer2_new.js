...
function save_my_dy_form(campaign)
{
	var dy_var = get_dy_fields();	
	var VLupdate_query = dy_var;
	var xmlhttp=false;
	...
	{ 
		...
		xmlhttp.open('POST', 'save_dy_form.php'); 
		xmlhttp.setRequestHeader('Content-Type','application/x-www-form-urlencoded; charset=UTF-8');
		xmlhttp.send(VLupdate_query); 
		xmlhttp.onreadystatechange = function() 
		{ 
			...
			//	conf_dialed=1;
				...
				if (xmlhttpXF) 
					...
					if (taskvar == 'FROMParK')
						...
						document.getElementById("ParkControl").innerHTML ="<a href=\"#\" onclick=\"mainxfer_send_redirect('ParK','" + redirectdestination + "','" + redirectdestserverip + "','','','','YES');return false;\"><img src=\"assets2/images/call-park.svg\" width=\"50\" alt=\"Park Call\" class=\"rounded-circle\"><br>Park Call</a>";
						if ( (ivr_park_call=='ENABLED') || (ivr_park_call=='ENABLED_PARK_ONLY') )
							{
					...
					xmlhttprequestselectupdate.onreadystatechange = function() 
						...
						//	alert(xmlhttprequestselectupdate.responseText);
							...
							if (change_array[0] == '1')
								...
								document.getElementById("WebFormSpan").innerHTML = "<a href=\"" + TEMP_VDIC_web_form_address + "\" target=\"" + web_form_target + "\" onMouseOver=\"WebFormRefresH();\" onclick=\"webform_click_log('webform1');\" class=\"btn btn-primary  text-white\"><img src=\"assets2/images/online-form-icon.webp\" width=\"50\" alt=\"Web Form\" class=\"rounded-circle\"> <br>WEB FORM</a>\n";
						...
						if (taskCheckOR == 'YES')
							...
							if ( (MDchannel.match(regMDL)) && (asterisk_version != '1.0.8') && (asterisk_version != '1.0.9') )
								...
								document.getElementById("MainStatuSSpan").innerHTML = " Called: " + status_display_number + " " + status_display_content + " &nbsp;"; 
									console.log("park4");
                                document.getElementById("ParkControl").innerHTML ="<a href=\"#\" onclick=\"mainxfer_send_redirect('ParK','" + lastcustchannel + "','" + lastcustserverip + "','','','','YES');return false;\" class=\"btn btn-primary  text-white\"><img src=\"assets2/images/call-park.svg\" width=\"50\" alt=\"Park Call\" class=\"rounded-circle\"><br>Park Call</a>";
								if ( (ivr_park_call=='ENABLED') || (ivr_park_call=='ENABLED_PARK_ONLY') )
									{
                                ...
                                document.getElementById("HangupControl").innerHTML = "<a href=\"#\" onclick=\"dialedcall_send_hangup('','','','','YES');\"><img src=\"assets2/images/dis-connect.png\" width=\"50\" alt=\"Dis-Connect\" class=\"rounded-circle\"><br>Dis-Connect</a>";

                                document.getElementById("XferControl").innerHTML = "<a href=\"#\" onclick=\"ShoWTransferMain('ON','','YES');\" class=\"btn btn-primary btn-sm text-white\"><img src=\"assets2/images/call-trans2.png\" width=\"50\" alt=\"Transfer - Conf\"  class=\"rounded-circle\"> <br>Transfer - Conf</a>";
	...
	function ManualDialNext(mdnCBid,mdnBDleadid,mdnDiaLCodE,mdnPhonENumbeR,mdnStagE,mdVendorid,mdgroupalias,mdtype,MDNclick)
		...
		if (waiting_on_dispo > 0)
			...
			if (starting_dial_level == 0)
				{
				document.getElementById("DiaLControl").innerHTML = "<a href=\"#\" onclick=\"ManualDialNext('','','','','','0','','','YES');\"><img src=\"assets2/images/dial_next1.jpg\" width=\"50\" alt=\"Dial Next\" class=\"rounded-circle\"><br>Dial Next</a>";
				}
			else
				{
				if (dial_method == "INBOUND_MAN")
					...
					document.getElementById("DiaLControl").innerHTML = "<a href=\"#\" onclick=\"AutoDial_ReSume_PauSe('VDADready','','','','','','','YES');\"><img src=\"assets2/images/break-time-icon.webp\" width=\"50\" alt=\"On Break\" class=\"rounded-circle\"><br>On Break</a><a href=\"#\" onclick=\"ManualDialNext('','','','','','0','','','YES');\"><img src=\"assets2/images/dial_next1.jpg\" width=\"50\" alt=\"Dial Next\" class=\"rounded-circle\"><br>Dial Next</a>";
					}
				else
					{
			...
			if (dial_method == "INBOUND_MAN")
				...
				document.getElementById("DiaLControl").innerHTML = "<a href=\"#\" class=\"not-allowed\"><img src=\"assets2/images/break-time-icon.webp\" width=\"50\" alt=\"On Break\" class=\"rounded-circle\"><br>On Break</a><a href=\"#\" class=\"not-allowed\"><img src=\"assets2/images/dial_next1.jpg\" width=\"50\" alt=\"Dial Next\" class=\"rounded-circle\"><br>Dial Next</a>";
				}
			else
				{
				if (active_ingroup_dial.length < 1)
					{
					document.getElementById("DiaLControl").innerHTML = "<a href=\"#\" class=\"not-allowed\"><img src=\"assets2/images/dial_next1.jpg\" width=\"50\" alt=\"Dial Next\" class=\"rounded-circle\"><br>Dial Next</a>";
					}
				}
			...
			if ( (CFAI_sent > 0) && (APRclick=='YES') )
				...
				if (taskaction == 'VDADready')
					...
					if (dial_method == "INBOUND_MAN")
						...
						document.getElementById("DiaLControl").innerHTML = "<a href=\"#\" onclick=\"AutoDial_ReSume_PauSe('VDADpause','','','','','','','YES');\"><img src=\"assets2/images/agent_ready.png\" width=\"50\" alt=\"Active\" class=\"rounded-circle\"><br>Active</a><a href=\"#\" onclick=\"ManualDialNext('','','','','','0','','','YES');\"><img src=\"assets2/images/dial_next1.jpg\" width=\"50\" alt=\"Dial Next\" class=\"rounded-circle\"><br>Dial Next</a>";
						}
					else
						{
					...
					//	alert(xmlhttprequestcheckauto.responseText);
						...
						//	DialLog("start");
							...
							if ( (inbound_post_call_survey=='ENABLED') && (inbound_survey_participate=='Y') )
								...
								document.vicidial_form.xferoverride.checked=true;
								document.getElementById("HangupControl").innerHTML = "<a href=\"#\" onclick=\"mainxfer_send_redirect('XfeRBLIND','" + lastcustchannel + "','" + lastcustserverip + "','','','','YES');return false;\"><img src=\"assets2/images/dis-connect.png\" width=\"50\" alt=\"Dis-Connect\" class=\"rounded-circle\"><br>Dis-Connect</a>";
...
// refresh the content of the web form URL
	function WebFormRefresH(taskrefresh,submittask,force_webvars_refresh) 
		...
		if (taskrefresh == 'OUT')
			{
            document.getElementById("WebFormSpan").innerHTML = "<a href=\"" + TEMP_VDIC_web_form_address + "\" target=\"" + web_form_target + "\" onMouseOver=\"WebFormRefresH('IN');\" onclick=\"webform_click_log('webform1');\" class=\"btn btn-primary  text-white\"><img src=\"assets2/images/online-form-icon.webp\" width=\"50\" alt=\"Web Form\" class=\"rounded-circle\"> <br>WEB FORM</a>\n";
			}
		else 
			{
            document.getElementById("WebFormSpan").innerHTML = "<a href=\"" + TEMP_VDIC_web_form_address + "\" target=\"" + web_form_target + "\" onMouseOut=\"WebFormRefresH('OUT');\" onclick=\"webform_click_log('webform1');\" class=\"btn btn-primary  text-white\"><img src=\"assets2/images/online-form-icon.webp\" width=\"50\" alt=\"Web Form\" class=\"rounded-circle\"> <br>WEB FORM</a>\n";
			}
		}
	...
	function dialedcall_send_hangup(dispowindow,hotkeysused,altdispo,nodeletevdac,DSHclick) 
		...
		if (required_fail > 0)
			...
			//  DEACTIVATE CHANNEL-DEPENDANT BUTTONS AND VARIABLES
				...
				if( document.images ) { document.images['livecall'].src = image_livecall_OFF.src;}
				document.getElementById("WebFormSpan").innerHTML = "<img src=\"assets2/images/online-form-icon.webp\" width=\"50\" alt=\"Web Form\" class=\"rounded-circle\"> <br>Web Form";
				if (enable_second_webform > 0)
					{
				...
				if (enable_third_webform > 0)
					...
					console.log("park7");
				document.getElementById("ParkControl").innerHTML = "<img src=\"assets2/images/call-parked.png\" width=\"50\" alt=\"Parked Call\" class=\"rounded-circle\"> <br>Parked Call";
				if ( (ivr_park_call=='ENABLED') || (ivr_park_call=='ENABLED_PARK_ONLY') )
					{
					document.getElementById("ivrParkControl").innerHTML = "<img src=\"./images/vdc_LB_ivrparkcall_OFF.gif\" border=\"0\" alt=\"IVR Park Call\" />";
					}
				document.getElementById("HangupControl").innerHTML = "<img src=\"assets2/images/dis-connect.png\" width=\"50\" alt=\"Dis-Connect\" class=\"rounded-circle\"><br>Dis-Connect";
				document.getElementById("XferControl").innerHTML = "<a href=\"#\" class=\"not-allowed\"><img src=\"assets2/images/call-trans2.png\" width=\"50\" alt=\"Transfer - Conf\"  class=\"rounded-circle\"> <br>Transfer - Conf</a>";
	...
	function ShoWTransferMain(showxfervar,showoffvar,SXMclick)
		...
		if (VU_vicidial_transfers == '1')
			...
			if (showxfervar == 'ON')
                ...
                document.getElementById("XferControl").innerHTML = "<a href=\"#\" onclick=\"ShoWTransferMain('OFF','YES','YES');\" class=\"btn btn-primary btn-sm text-white\"><img src=\"assets2/images/call-trans2.png\" width=\"50\" alt=\"Transfer - Conf\"  class=\"rounded-circle\"> <br>Transfer - Conf</a>";
