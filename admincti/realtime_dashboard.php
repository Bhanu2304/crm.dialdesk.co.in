...
require("include/screen_colors.php");
...
function gather_realtime_content()
{
	...
	if (xmlhttp) 
	{
		...
		xmlhttp.open('POST', 'time_on_call.php'); 
		xmlhttp.setRequestHeader('Content-Type','application/x-www-form-urlencoded; charset=UTF-8');
		...
		if (DB > 0)	
		{
			document.getElementById("ajaxdebug").innerHTML = RTupdate_query;
		}
	}
}
...
?>
	...
	if (task_option == 'form_submit')
		...
		if(task_choice== "noida")
		{
			var selIngrpContainer = document.createElement('div'); 
			selIngrpContainer.innerHTML = '<select name="ingroup_filter[]" id="ingroup_filter[]" multiple="">'+
                        '<option selected="" value="MRUN_Option11">MRUN_Option11</option>'+
                        '<option selected="" value="MRUN_Option12">MRUN_Option12</option>'+
                        '<option selected="" value="MRUN_Option13">MRUN_Option13</option>'+
						'<option selected="" value="MRUN_Option14">MRUN_Option14</option>'+
						'<option selected="" value="MRUN_Option15">MRUN_Option15</option>'+
						'<option selected="" value="MRUN_Option16">MRUN_Option16</option>'+
						'<option selected="" value="MRUN_Option21">MRUN_Option21</option>'+
						'<option selected="" value="MRUN_Option22">MRUN_Option22</option>'+
						'<option selected="" value="MRUN_Option31">MRUN_Option31</option>'+
						'<option selected="" value="MRUN_Option32">MRUN_Option32</option>'+
						'<option selected="" value="MRUN_Option33">MRUN_Option33</option>'+
						'<option selected="" value="MRUN_Option34">MRUN_Option34</option>'+
						'<option selected="" value="MRUN_Option41">MRUN_Option41</option>'+
						'<option selected="" value="MRUN_Option42">MRUN_Option42</option>'+
						'<option selected="" value="MRUN_Option43">MRUN_Option43</option>'+
						'<option selected="" value="MRUN_Option44">MRUN_Option44</option>'+
						'<option selected="" value="MRUN_Option51">MRUN_Option51</option>'+
						'<option selected="" value="MRUN_Option52">MRUN_Option52</option>'+
						'<option selected="" value="MRUN_Option61">MRUN_Option61</option>'+
						'<option selected="" value="MRUN_Option62">MRUN_Option62</option>'+
						'<option selected="" value="MRUN_Option63">MRUN_Option63</option>'+
						'<option selected="" value="MRUN_Option64">MRUN_Option64</option>'+
						'<option selected="" value="MRUN_Option71">MRUN_Option71</option>'+
						'<option selected="" value="MRUN_Option72">MRUN_Option72</option>'+
						'<option selected="" value="MRUN_Option73">MRUN_Option73</option>'+
						'<option selected="" value="MRUN_Option74">MRUN_Option74</option>'+
						'<option selected="" value="MRUN_Option75">MRUN_Option75</option>'+
						'<option selected="" value="MRUN_Option76">MRUN_Option76</option>'+
                      '</select>';

			var selIngrpObj = selIngrpContainer.firstChild;


		}else if(task_choice== "lucknow")
		{
			var selIngrpContainer = document.createElement('div'); 
			selIngrpContainer.innerHTML = '<select name="ingroup_filter[]" id="ingroup_filter[]" multiple="">'+
                        '<option selected="" value="MRUL_Option11">MRUL_Option11</option>'+
                        '<option selected="" value="MRUL_Option12">MRUL_Option12</option>'+
                        '<option selected="" value="MRUL_Option13">MRUL_Option13</option>'+
						'<option selected="" value="MRUL_Option14">MRUL_Option14</option>'+
						'<option selected="" value="MRUL_Option15">MRUL_Option15</option>'+
						'<option selected="" value="MRUL_Option21">MRUL_Option21</option>'+
						'<option selected="" value="MRUL_Option22">MRUL_Option22</option>'+
						'<option selected="" value="MRUL_Option23">MRUL_Option23</option>'+
						'<option selected="" value="MRUL_Option24">MRUL_Option24</option>'+
						'<option selected="" value="MRUL_Option31">MRUL_Option31</option>'+
						'<option selected="" value="MRUL_Option32">MRUL_Option32</option>'+
						'<option selected="" value="MRUL_Option33">MRUL_Option33</option>'+
						'<option selected="" value="MRUL_Option34">MRUL_Option34</option>'+
						'<option selected="" value="MRUL_Option41">MRUL_Option41</option>'+
						'<option selected="" value="MRUL_Option42">MRUL_Option42</option>'+
						'<option selected="" value="MRUL_Option43">MRUL_Option43</option>'+
                      '</select>';
...
<!--
	...
	tr.TRcyan {background-color: #27a9e3}
	...
	tr.TRsaddlebrown {background-color: #e67300}
...
else
{
	...
	// echo "<div style='text-align: center;'><a href=\"#\" onclick=\"update_variables('form_submit','','YES')\"><span class='badge rounded-pill bg-cyan text-big'>"._QXZ("Lucknow")."</span></a>";
	// echo " &nbsp; &nbsp; &nbsp; <a href=\"#\" onclick=\"update_variables('form_submit','','YES')\"><span class='badge rounded-pill bg-danger text-big'>"._QXZ("Noida")."</span></a>\n\n";
	// echo "</div>";
	echo "<div style='text-align: center;'>";
	// echo "<a href=\"#\" onclick=\"showDiv('campaign_select_list');\">Choose Report Display Options</a>";
	echo "<td><a href='#' data-toggle='modal' data-target='#myModal'>Choose Report Display Options</a></td>";
	echo "</div>";

	if($PHP_AUTH_USER == 'MHS011')
	{
		echo "<div style='text-align: center;'>";
		echo "<a href=\"#\" onclick=\"update_variables('form_submit','lucknow','YES');\"><span class='badge rounded-pill bg-cyan text-big'>"._QXZ("Lucknow")."</span></a>";
		echo "&nbsp; &nbsp; &nbsp;<a href=\"#\" onclick=\"update_variables('form_submit','noida','YES');\"><span class='badge rounded-pill bg-danger text-big'>"._QXZ("Noida")."</span></a>";
		# echo "&nbsp; &nbsp; &nbsp;<a href=\"#\" onclick=\"update_variables('form_submit','All','YES');\"><span class='badge rounded-pill bg-success text-big'>"._QXZ("All")."</span></a>";
		echo "</div>";
	}
	
	# echo '<span class="icon-bg"><i class="material-icons">fullscreen</i></span>';
	echo "<div style='text-align: right;'><a href=\"#\" onclick=\"update_variables('form_submit','','YES')\"><span class='badge rounded-pill bg-primary'>"._QXZ("RELOAD NOW")."</span></a>";
          ...
          echo '<div class="modal-dialog modal-dialog-centered">';
            echo '<div class="modal-content">';
              ...
              echo '<div class="modal-header">';
                echo '<h4 class="modal-title">Action</h4>';
              echo '</div>';
              ...
              echo '<div class="modal-body">';
				...
				echo "<div class='col-sm-6'>";
					echo '<label>Monitor</label>';
					 echo "<select class=\"form-control\" name=\"monitor_active\" id='monitor_active'>";
							echo "<option value=''>Select</option>";
							echo "<option value=\"MONITOR\" " . ($monitor_active == 'MONITOR' ? ' selected' : '') . ">MONITOR</option>";
							echo "<option value=\"BARGE\" " . ($monitor_active == 'BARGE' ? ' selected' : '') . ">BARGE</option>";
							echo "<option value=\"WHISPER\" " . ($monitor_active == 'WHISPER' ? ' selected' : '') . ">WHISPER</option>";
						echo "</select>";
					echo '<small class="text-danger" id="error-status"></small>';
				echo '</div>';

				echo "<div class='col-sm-6'>";
					echo '<label>Phone</label>';
					echo '<input type="text" class="form-control" name="monitor_phone" id="monitor_phone" value="'.$monitor_phone.'">';
					echo '<small class="text-danger" id="error-substatus"></small>';
				echo '</div>';
				echo '</div>';
              echo '</div>';
              
              echo '<div class="modal-footer">';
			  	// <!-- <button type="button" class="btn btn-primary" onclick="update_variables('form_submit','');">Save</button> -->
				// echo '<button type="button" class="btn btn-primary" onclick="update_variables('form_submit','')">Save</button>';
				echo '<button type="button" class="btn btn-primary" onclick="update_variables(\'form_submit\', \'\')">Send</button>';
