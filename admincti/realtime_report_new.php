...
$select_list .= "<SELECT SIZE=5 NAME=groups[] ID=groups[] multiple>";
$o=0;
...
$select_list .= "<SELECT SIZE=5 NAME=user_group_filter[] ID=user_group_filter[] multiple>";
$o=0;
...
$select_list .= "<SELECT SIZE=5 NAME=ingroup_filter[] ID=ingroup_filter[] multiple>";
$o=0;
...
$select_list .= "<a style='position:relative;left:90px;' href='#' onclick=\\\"hideDiv('campaign_select_list');\\\">"._QXZ("Close Panel")."</a><BR><BR>";
$select_list .= "<TABLE CELLPADDING=2 CELLSPACING=2 BORDER=0>";

$select_list .= "<TR><TD align=right>";
$select_list .= _QXZ("Screen Refresh Rate").":  </TD><TD align=left><SELECT style='width:110px;height:35px;' SIZE=1 NAME=RR ID=RR>";
...
$select_list .= "<TR><TD align=right>";
$select_list .= _QXZ("Inbound").":  </TD><TD align=left><SELECT style='width:110px;height:35px;' style='width:110px;height:35px;' SIZE=1 NAME=with_inbound ID=with_inbound>";
...
$select_list .= "<TR><TD align=right>";
$select_list .= _QXZ("Monitor").":  </TD><TD align=left><SELECT style='width:110px;height:35px;' SIZE=1 NAME=monitor_active ID=monitor_active>";
...
$select_list .= "<INPUT style='width:110px;height:35px;' type=text size=10 maxlength=20 NAME=monitor_phone ID=monitor_phone VALUE='$monitor_phone'>";
$select_list .= "</TD></TR>";
...
if ($UGdisplay > 0)
	...
	$select_list .= "<SELECT style='width:110px;height:35px;' SIZE=1 NAME=usergroup ID=usergroup>";
...
$select_list .= "<TR><TD align=right>";
$select_list .= _QXZ("Dialable Leads Alert").":  </TD><TD align=left><SELECT style='width:110px;height:35px;' SIZE=1 NAME=NOLEADSalert ID=NOLEADSalert>";
$select_list .= "<option value=''";
...
$select_list .= "<TR><TD align=right>";
$select_list .= _QXZ("Show Drop In-Group Row").":  </TD><TD align=left><SELECT style='width:110px;height:35px;' SIZE=1 NAME=DROPINGROUPstats ID=DROPINGROUPstats>";
...
$select_list .= "<TR><TD align=right>";
$select_list .= _QXZ("Show Carrier Stats").":  </TD><TD align=left><SELECT style='width:110px;height:35px;' SIZE=1 NAME=CARRIERstats ID=CARRIERstats>";
$select_list .= "<option value='0'";
...
if ($presets_enabled > 0)
	{
	$select_list .= "<TR><TD align=right>";
	$select_list .= _QXZ("Show Presets Stats").":  </TD><TD align=left><SELECT style='width:110px;height:35px;' SIZE=1 NAME=PRESETstats ID=PRESETstats>";
	$select_list .= "<option value='0'";
...
$select_list .= "<TR><TD align=right>";
$select_list .= _QXZ("Agent Time Stats").":  </TD><TD align=left><SELECT style='width:110px;height:35px;' SIZE=1 NAME=AGENTtimeSTATS ID=AGENTtimeSTATS>";
$select_list .= "<option value='0'";
...
$select_list .= "<TR><TD align=right>";
$select_list .= _QXZ("In-group color override").":  </TD><TD align=left><SELECT style='width:110px;height:35px;' SIZE=1 NAME=INGROUPcolorOVERRIDE ID=INGROUPcolorOVERRIDE>";
$select_list .= "<option value='0'";
...
$select_list .= "<TR><TD align=right>";
$select_list .= _QXZ("Display as").":  </TD><TD align=left><SELECT style='width:110px;height:35px;' SIZE=1 NAME=report_display_type ID=report_display_type>";
...
$select_list .= "<INPUT class='btn btn-web pull-right' type=button VALUE=SUBMIT onclick=\\\"update_variables('form_submit','');\\\"><FONT FACE='ARIAL,HELVETICA' COLOR=BLACK SIZE=2> &nbsp; &nbsp; &nbsp; &nbsp; ";
$select_list .= "</TD></TR>";
...
echo "<TITLE>$report_name: $group</TITLE>";
require("include/header.php");
echo "</HEAD>";
echo "<BODY  marginheight=0 marginwidth=0 leftmargin=0 topmargin=0 class='animated-content infobar-overlay sidebar-scroll' >\n";
...
echo "<TABLE CELLPADDING=4 CELLSPACING=0 class='table table-striped table-bordered datatables' id='editable1'><TR><TD>";
...
echo "<font class='top_head_key' style='display: none'>"._QXZ("$report_name")." &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; \n";
...
echo "<a style='position:relative;top:4px;' href=\"#\" onclick=\"showDiv('campaign_select_list');\"><font class='top_head_key'>"._QXZ("Choose Report Display Options")."</a>";
echo "</TD></TR></TABLE>\n";
echo "</span>\n";
...
echo "<TABLE WIDTH=" . $webphone_bufw . " CELLPADDING=" . $webphone_pad . " CELLSPACING=0 class='table table-striped table-bordered datatables' id='editable1'><TR><TD ALIGN=LEFT>\n";
...
echo " &nbsp; ";
echo "</span>\n";
echo "<a href=\"#\" onclick=\"update_variables('form_submit','','YES')\"><font class='top_settings_val' style='display: none'>"._QXZ("RELOAD NOW")."</font></a>";
if ($LOGuser_level > 7)
	{
	if (preg_match('/ALL\-ACTIVE/i',$group_string))
		{echo " &nbsp; &nbsp; &nbsp; <a href=\"./admin.php?ADD=10\"><font class='top_settings_val' style='display: none'>"._QXZ("MODIFY")."</font></a> | \n";}
	else
		{echo " &nbsp; &nbsp; &nbsp; <a href=\"./admin.php?ADD=34&campaign_id=$group\"><font class='top_settings_val' style='display: none'>"._QXZ("MODIFY")."</font></a> | \n";}
	}

if ($SUMMARYauth > 0)
	{echo "<a href=\"./AST_timeonVDADallSUMMARY.php?RR=$RR&DB=$DB&adastats=$adastats\"><font class='top_settings_val' style='display: none'>"._QXZ("SUMMARY")."</font></a> \n";}
...
echo " &nbsp; &nbsp; &nbsp; <font class='top_settings_val' style='display: none'>"._QXZ("refresh").": <span id=refresh_countdown name=refresh_countdown style='display: none'></span></font>\n\n";
