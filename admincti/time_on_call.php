...
if ($RTajax > 0)
	...
	echo "<TITLE>$report_name: $group</TITLE></HEAD>";
...
#	echo "<td width=5 rowspan=2> &nbsp; </td>";
	...
	if ($campaign_allow_inbound > 0)
	{
		...
		echo '<div class="box bg-success text-center">';
		echo '<h1 class="font-light text-white">';
		echo '<i class="mdi mdi-phone fs-3 mb-1 font-16"></i>';
		echo '</h1>';
		echo '<h5 class="mb-0 mt-1 text-white">'.$out_total.'</h5>';
		echo '<small class="text-white">Current Active Calls</small>';
		echo '</div>';
		echo '</div>';
		echo '</div>';
	...
	else
	{
		...
		echo '</h1>';
		#echo '<h5 class="mb-0 mt-1 text-white">'.$out_total.'</h5>';
		echo '<small class="text-white">Calls being placed</small>';
		echo '</div>';
		echo '</div>';
		echo '</div>';
	}
	...
	echo '<div class="col-lg-2 col-md-6 col-sm-6 col-xs-12">';
	echo '<div class="card card-hover">';
	echo '<div class="box bg-cyan text-center">';
	echo '<h1 class="font-light text-white">';
	echo '<i class="mdi mdi-bell-ring fs-3 mb-1 font-16"></i>';
	echo '</h1>';
	echo '<h5 class="mb-0 mt-1 text-white">'.$out_ring.'</h5>';
	echo '<small class="text-white">Calls Ringing</small>';
	echo '</div>';
	echo '</div>';
	echo '</div>';
	...
	echo '<div class="col-lg-2 col-md-6 col-sm-6 col-xs-12">';
	echo '<div class="card card-hover">';
	echo '<div class="box bg-warning text-center">';
	echo '<h1 class="font-light text-white">';
	echo '<i class="mdi mdi-av-timer fs-3 mb-1 font-16"></i>';
	echo '</h1>';
	echo '<h5 class="mb-0 mt-1 text-white">'.$out_live.'</h5>';
	echo '<small class="text-white">Calls waiting for agents</small>';
	echo '</div>';
	echo '</div>';
	echo '</div>';
	...
	echo '<div class="col-lg-2 col-md-6 col-sm-6 col-xs-12">';
	echo '<div class="card card-hover">';
	echo '<div class="box bg-info text-center">';
	echo '<h1 class="font-light text-white">';
	echo '<i class="mdi mdi-deskphone fs-3 mb-1 font-16"></i>';
	echo '</h1>';
	echo '<h5 class="mb-0 mt-1 text-white">'.$in_ivr.'</h5>';
	echo '<small class="text-white">Calls in IVR</small>';
	echo '</div>';
	echo '</div>';
	echo '</div>';
	...
	echo '<div class="col-lg-2 col-md-6 col-sm-6 col-xs-12">';
	echo '<div class="card card-hover">';
	echo '<div class="box bg-danger text-center">';
	echo '<h1 class="font-light text-white">';
	echo '<i class="mdi mdi-av-timer fs-3 mb-1 font-16"></i>';
	echo '</h1>';
	echo '<h5 class="mb-0 mt-1 text-white">'.$icbq_live.'</h5>';
	echo '<small class="text-white">Callback queue calls</small>';
	echo '</div>';
	echo '</div>';
	echo '</div>';
...
{
	$Cecho = '';
	$Cecho .= "<table cellpadding=1 cellspacing=1 border=1 width=680>";
	$Cecho .= "<tr>";
...
while($p<$k)
{
	...
	if ($CDcall_type[$p] == 'IN' || $CDcall_type[$p] == 'CHAT')
		...
		$Ccampaign_id="<a href='#'>$Ccampaign_id</a>";
		}
...
{
	$Aecho = '';
	$Aecho .= "<table cellpadding=1 cellspacing=1 border=0 class='table table-bordered datatables ' >";
	$Aecho .= "<tr>";
...
#				{$G='<SPAN class="orange"><B>'; $EG='</B></SPAN>';}
		...
		if ( (preg_match("/READY/i",$status)) or (preg_match("/CLOSER/i",$status)) ) 
			...
			if ($RS_agentWAIT == 4)
				...
				if ($call_time_S >= $rt_report_times["waiting_medium_time"]) {$G='<SPAN class="blue"><B>'; $EG='</B></SPAN>'; $tr_class='TRcyan';}
		...
		if ( ($report_display_type=='HTML') or ($report_display_type=='LIMITED') )
			...
			if ($agent_pause_codes_active > 0)	{$pausecodeHTML = "<td bgcolor=white align=center><font class='Hblank1'>$pausecode</td>";}
			else	{$pausecodeHTML = "";}
			...
			if ($filtered_ingroup==1) 
			{
				if ($realtime_block_user_info > 0)
				{
					$Aecho .= "<tr class='12'><td >$UGD $G$sessionid$EG$L$R$Aring_note[$i]</td>
					<td align=center>$MO $G"._QXZ("$status",6)."$EG</td>
					<td bgcolor=white align=center><font class='Hblank2'>$CM</td>
					$pausecodeHTML<td NOWRAP align=right>$CP$CI$SVD$G$call_time_MS$EG </td>
					<td NOWRAP align=right> $G$campaign_id$EG </td>
					<td NOWRAP align=right> $G$calls_today$EG </td>
					$LATENCY$ASTCT$INGRP</tr>\n";
				}
				if ($realtime_block_user_info < 1)
				{
					$Aecho .= "<tr class='$tr_class'>
					<td> $extension$EG$Aring_note[$i]</td>
					<td>$user </td>
					<td>$UGD $sessionid$EG$L$R </td>
					<td>$MO "._QXZ("$status",6)."$EG</td>
					<td><font class='Hblank3'>$CM</td>
					$pausecodeHTML<td>$CP$CI$SVD$call_time_MS$EG </td>
					<td> $campaign_id$EG </td>
					<td> $calls_today$EG </td>
					$LATENCY$ASTCT$INGRP</tr>\n";
				}
			}
		}
...
if ( ($report_display_type=='HTML') or ($report_display_type=='WALL_2') or ($report_display_type=='LIMITED') )
	...
	echo '<div class="box bg-info text-center">';
	echo '<h1 class="font-light text-white">';
	echo '<i class="mdi mdi-account fs-3 mb-1 font-16"></i>';
	echo '</h1>';
	echo '<h5 class="mb-0 mt-1 text-white">'.$agent_total.'</h5>';
	echo '<small class="text-white">Agents logged in</small>';
	echo '</div>';
	echo '</div>';
	echo '</div>';
	...
	echo '<div class="box bg-success text-center">';
	echo '<h1 class="font-light text-white">';
	echo '<i class="mdi mdi-phone-in-talk fs-3 mb-1 font-16"></i>';
	echo '</h1>';
	echo '<h5 class="mb-0 mt-1 text-white">'.$agent_incall.'</h5>';
	echo '<small class="text-white">Agents in calls</small>';
	echo '</div>';
	echo '</div>';
	echo '</div>';
	...
	echo '<div class="box bg-danger text-center">';
	echo '<h1 class="font-light text-white">';
	echo '<i class="mdi mdi-timer-sand fs-3 mb-1 font-16"></i>';
	echo '</h1>';
	echo '<h5 class="mb-0 mt-1 text-white">'.$agent_ready.'</h5>';
	echo '<small class="text-white">Agents waiting</small>';
	echo '</div>';
	echo '</div>';
	echo '</div>';
	...
	echo '<div class="box bg-warning text-center">';
	echo '<h1 class="font-light text-white">';
	echo '<i class="mdi mdi-phone-paused fs-3 mb-1 font-16"></i>';
	echo '</h1>';
	echo '<h5 class="mb-0 mt-1 text-white">'.$agent_paused.'</h5>';
	echo '<small class="text-white">Paused agents</small>';
	echo '</div>';
	echo '</div>';
	echo '</div>';
	...
	echo '<div class="box bg-cyan text-center">';
	echo '<h1 class="font-light text-white">';
	echo '<i class="mdi mdi-account-remove fs-3 mb-1 font-16"></i>';
	echo '</h1>';
	echo '<h5 class="mb-0 mt-1 text-white">'.$agent_dead.'</h5>';
	echo '<small class="text-white">Agents in dead calls</small>';
	echo '</div>';
	echo '</div>';
	echo '</div>';
	...
	echo '<div class="col-lg-2 col-md-6 col-sm-6 col-xs-12">';
	echo '<div class="card card-hover">';
	echo '<div class="box bg-primary text-center">';
	echo '<h1 class="font-light text-white">';
	echo '<i class="mdi mdi-phone-forward fs-3 mb-1 font-16"></i>';
	echo '</h1>';
	echo '<h5 class="mb-0 mt-1 text-white">'.$agent_dispo.'</h5>';
	echo '<small class="text-white">Agents in dispo</small>';
	echo '</div>';
	echo '</div>';
	echo '</div>';
	...
	if ($report_display_type=='LIMITED')
	{
		...
		echo '<div class="box bg-cyan text-center">';
		echo '<h1 class="font-light text-white">';
		echo '<i class="mdi mdi-view-dashboard"></i>';
		echo '</h1>';
		echo '<h5 class="mb-0 mt-1 text-white">'.$avgwaitTODAY.'</h5>';
		echo '<small class="text-white">Avg agent wait seconds</small>';
		echo '</div>';
		echo '</div>';
		echo '</div>';
		...
		echo '<i class="mdi mdi-view-dashboard"></i>';
		echo '</h1>';
		echo '<h5 class="mb-0 mt-1 text-white">'.$avgcustTODAY.'</h5>';
		echo '<small class="text-white">Avg agent talk seconds</small>';
		echo '</div>';
		echo '</div>';
		echo '</div>';
		...
		echo '<i class="mdi mdi-view-dashboard"></i>';
		echo '</h1>';
		echo '<h5 class="mb-0 mt-1 text-white">'.$avgparksecallTODAY.'</h5>';
		echo '<small class="text-white">Avg call park seconds</small>';
		echo '</div>';
		echo '</div>';
		echo '</div>';
		...
		echo '<i class="mdi mdi-view-dashboard"></i>';
		echo '</h1>';
		echo '<h5 class="mb-0 mt-1 text-white">'.$PCThold_sec_stat_one.'</h5>';
		echo '<small class="text-white">inbound SLA</small>';
		echo '</div>';
		echo '</div>';
		echo '</div>';
