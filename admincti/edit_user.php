            ...
            <div data-widget-group="group1">
                <div class="card" data-widget='{"draggable": "false"}'>
                    ...
                    <div class="card-body">
                        ...
                        ?>
                        <form action="edit_user.php?user=<?php echo $user; ?>" method="post">
                          ...
                          <div class="row">
                            ...
                            <div class='col-sm-2'><input type=password class='form-control' id=reg_pass name=pass maxlength=100 value="<?php echo $pass; ?>" onkeyup="return pwdChanged('reg_pass','reg_pass_img');"></div>
                            <div class='col-sm-2'>Strength : 
                              <img id=reg_pass_img src='assets/images/pixel.gif' style="vertical-align:middle;" onload="pwdChanged('reg_pass','reg_pass_img');">
                            </div>
                          ...
                          <div class='row'>
                            <?php if($SSuser_territories_active > 0)
                              ...
                              if ( ($LOGuser_level > 8) and ($LOGalter_admin_interface > 0) )
                              {
                                ...
                                echo "<div class='col-sm-2'><select class='form-control' class='form-control'  name=modify_remoteagents><option>0</option><option>1</option><option SELECTED>$modify_remoteagents</option></select></div>";
                                
				
                                echo "<label class='col-sm-2 control-label'>Delete Remote Agents</label>";
                                echo "<div class='col-sm-2'><select class='form-control' class='form-control'  name=delete_remote_agents><option>0</option><option>1</option><option SELECTED>$delete_remote_agents</option></select></div>";
                                

				                        echo "<label class='col-sm-2 control-label'>Modify Scripts</label>";
                                echo "<div class='col-sm-2'><select class='form-control' class='form-control'  name=modify_scripts><option>0</option><option>1</option><option SELECTED>$modify_scripts</option></select></div>";
                                
				
                                echo "<label class='col-sm-2 control-label'>Delete Scripts</label>";
                                echo "<div class='col-sm-2'><select class='form-control' class='form-control'  name=delete_scripts><option>0</option><option>1</option><option SELECTED>$delete_scripts</option></select></div>";

                                if ($SSoutbound_autodial_active > 0)
                                {
                                  echo "<label class='col-sm-2 control-label'>Modify Filters</label>";
                                  echo "<div class='col-sm-2'><select class='form-control' class='form-control'  name=modify_filters><option>0</option><option>1</option><option SELECTED>$modify_filters</option></select></div>";
            
                                  echo "<label class='col-sm-2 control-label'>Delete Filters</label>";
                                  echo "<div class='col-sm-2'><select class='form-control' class='form-control'  name=delete_filters><option>0</option><option>1</option><option SELECTED>$delete_filters</option></select></div>";
                                                    
                                }

                                echo "<label class='col-sm-2 control-label'>AGC Admin Access</label>";
                                echo "<div class='col-sm-2'><select class='form-control' class='form-control'  name=ast_admin_access><option>0</option><option>1</option><option SELECTED>$ast_admin_access</option></select></div>";
				
                                echo "<label class='col-sm-2 control-label'>AGC Delete Phones</label>";
                                echo "<div class='col-sm-2'><select class='form-control' class='form-control'  name=ast_delete_phones><option>0</option><option>1</option><option SELECTED>$ast_delete_phones</option></select></div>";
                                
				
                                echo "<label class='col-sm-2 control-label'>Modify Call Times</label>";
                                echo "<div class='col-sm-2'><select class='form-control' class='form-control'  name=modify_call_times><option>0</option><option>1</option><option SELECTED>$modify_call_times</option></select></div>";
                                
				
                                echo "<label class='col-sm-2 control-label'>Delete Call Times</label>";
                                echo "<div class='col-sm-2'><select class='form-control' class='form-control'  name=delete_call_times><option>0</option><option>1</option><option SELECTED>$delete_call_times</option></select></div>";
                                
				
                                echo "<label class='col-sm-2 control-label'>Modify Servers</label>";
                                echo "<div class='col-sm-2'><select class='form-control' class='form-control'  name=modify_servers><option>0</option><option>1</option><option SELECTED>$modify_servers</option></select></div>";
                                

				                        echo "<label class='col-sm-2 control-label'>Modify Shifts</label>";
                                echo "<div class='col-sm-2'><select class='form-control' class='form-control'  name=modify_shifts><option>0</option><option>1</option><option SELECTED>$modify_shifts</option></select></div>";
                                
				
                                echo "<label class='col-sm-2 control-label'>Modify Phones</label>";
                                echo "<div class='col-sm-2'><select class='form-control' class='form-control'  name=modify_phones><option>0</option><option>1</option><option SELECTED>$modify_phones</option></select></div>";
                                
				
                                echo "<label class='col-sm-2 control-label'>Modify Carriers</label>";
                                echo "<div class='col-sm-2'><select class='form-control' class='form-control'  name=modify_carriers><option>0</option><option>1</option><option SELECTED>$modify_carriers</option></select></div>";


                                if ($SSallow_emails > 0) 
                                {
                                  echo "<label class='col-sm-2 control-label'>Modify Email Accounts</label>";
                                  echo "<div class='col-sm-2'><select class='form-control' class='form-control'  name=modify_email_accounts><option>0</option><option>1</option><option SELECTED>$modify_email_accounts</option></select></div>";
                                ...
                                echo "<div class='col-sm-2'><select class='form-control' class='form-control'  name=modify_labels><option>0</option><option>1</option><option SELECTED>$modify_labels</option></select></div>";
				
                                echo "<label class='col-sm-2 control-label'>Modify Colors</label>";
                                echo "<div class='col-sm-2'><select class='form-control' class='form-control'  name=modify_colors><option>0</option><option>1</option><option SELECTED>$modify_colors</option></select></div>";

                                if ($SSenable_languages > 0)
                                {
                                  echo "<label class='col-sm-2 control-label'>Modify Languages</label>";
                                  echo "<div class='col-sm-2'><select class='form-control' class='form-control'  name=modify_languages><option>0</option><option>1</option><option SELECTED>$modify_languages</option></select></div>";
                                ...
                                echo "<div class='col-sm-2'><select class='form-control' class='form-control'  name=modify_statuses><option>0</option><option>1</option><option SELECTED>$modify_statuses</option></select></div>";
				
                                echo "<label class='col-sm-2 control-label'>Modify Voicemail</label>";
                                echo "<div class='col-sm-2'><select class='form-control' class='form-control'  name=modify_voicemail><option>0</option><option>1</option><option SELECTED>$modify_voicemail</option></select></div>";
                                
				
                                echo "<label class='col-sm-2 control-label'>Modify Audio Store</label>";
                                echo "<div class='col-sm-2'><select class='form-control' class='form-control'  name=modify_audiostore><option>0</option><option>1</option><option SELECTED>$modify_audiostore</option></select></div>";
                                
				
                                echo "<label class='col-sm-2 control-label'>Modify Music On Hold</label>";
                                echo "<div class='col-sm-2'><select class='form-control' class='form-control'  name=modify_moh><option>0</option><option>1</option><option SELECTED>$modify_moh</option></select></div>";
                                
				
                                echo "<label class='col-sm-2 control-label'>Modify TTS</label>";
                                echo "<div class='col-sm-2'><select class='form-control' class='form-control'  name=modify_tts><option>0</option><option>1</option><option SELECTED>$modify_tts</option></select></div>";
                                
				
                                echo "<label class='col-sm-2 control-label'>Modify Contacts</label>";
                                echo "<div class='col-sm-2'><select class='form-control' class='form-control'  name=modify_contacts><option>0</option><option>1</option><option SELECTED>$modify_contacts</option></select></div>";
                                

				                        echo "<label class='col-sm-2 control-label'>CallCard Access</label>";
                                echo "<div class='col-sm-2'><select class='form-control' class='form-control'  name=callcard_admin><option>0</option><option>1</option><option SELECTED>$callcard_admin</option></select></div>";


                                if ($SSenable_auto_reports > 0)
                                {
                                  echo "<label class='col-sm-2 control-label'>Modify Automated Reports</label>";
                                  echo "<div class='col-sm-2'><select class='form-control' class='form-control'  name=modify_auto_reports><option>0</option><option>1</option><option SELECTED>$modify_auto_reports</option></select></div>";
                                }
                                else
                                {
                                ...
                                echo "<div class='col-sm-2'><select class='form-control' class='form-control'  name=add_timeclock_log><option>0</option><option>1</option><option SELECTED>$add_timeclock_log</option></select></div>";

                                echo "<label class='col-sm-2 control-label'>Modify Timeclock Log Record</label>";
                                echo "<div class='col-sm-2'><select class='form-control' class='form-control'  name=modify_timeclock_log><option>0</option><option>1</option><option SELECTED>$modify_timeclock_log</option></select></div>";
                                
				
                                echo "<label class='col-sm-2 control-label'>Delete Timeclock Log Record</label>";
                                echo "<div class='col-sm-2'><select class='form-control' class='form-control'  name=delete_timeclock_log><option>0</option><option>1</option><option SELECTED>$delete_timeclock_log</option></select></div>";
                                

				                        echo "<label class='col-sm-2 control-label'>Manager Shift Enforcement Override</label>";
                                echo "<div class='col-sm-2'><select class='form-control' class='form-control'  name=manager_shift_enforcement_override><option>0</option><option>1</option><option SELECTED>$manager_shift_enforcement_override</option></select></div>";
                                
				
                                echo "<label class='col-sm-2 control-label'>Manager Pause Code Approval</label>";
                                echo "<div class='col-sm-2'><select class='form-control' class='form-control'  name=pause_code_approval><option>0</option><option>1</option><option SELECTED>$pause_code_approval</option></select></div>";

                                if (preg_match("/cf_encrypt/",$SSactive_modules))
					                      {
                                    echo "<label class='col-sm-2 control-label'>Admin Custom Fields Show Hidden</label>";
                                    echo "<div class='col-sm-2'><select class='form-control' class='form-control'  name=admin_cf_show_hidden><option>0</option><option>1</option><option SELECTED>$admin_cf_show_hidden</option></select></div>";
                                ...
                                if ($SSallow_ip_lists > 0)
                                  ...
                                  echo "<div class='col-sm-2'><select class='form-control' class='form-control'  name=modify_ip_lists><option>0</option><option>1</option><option SELECTED>$modify_ip_lists</option></select></div>";
                                  
                                  echo "<label class='col-sm-2 control-label'>Ignore IP List</label>";
                                  echo "<div class='col-sm-2'><select class='form-control' class='form-control'  name=ignore_ip_list><option>0</option><option>1</option><option SELECTED>$ignore_ip_list</option></select></div>";
                                ...
                                echo "<div class='col-sm-2'><select class='form-control' class='form-control'  name=vdc_agent_api_access><option>0</option><option>1</option><option SELECTED>$vdc_agent_api_access</option></select></div>";
                                
                                echo "<label class='col-sm-2 control-label'>API List Restrict</label>";
                                echo "<div class='col-sm-2'><select class='form-control' class='form-control'  name=api_list_restrict><option>0</option><option>1</option><option SELECTED>$api_list_restrict</option></select></div>";
                                ...
                                echo "<div class='col-sm-2'><select class='form-control' class='form-control'  name=api_only_user><option>0</option><option>1</option><option SELECTED>$api_only_user</option></select></div>";
                                echo '</div>';
                                ...
                                if ( ( ($LOGmodify_same_user_level > 0) or ($LOGalter_admin_interface > 0) ) and ($LOGuser_level > 8) )
                                  ...
                                  else
                                  {
                                    ...
                                    echo "<div class='col-sm-2'><select class='form-control' class='form-control'  name=modify_same_user_level><option>0</option><option>1</option><option SELECTED>$modify_same_user_level</option></select></div>";
                                  ...
                                  else
                                  {
                                    ...
                                    echo "<div class='col-sm-2'><select class='form-control' class='form-control'  name=alter_admin_interface_options><option>0</option><option>1</option><option SELECTED>$LOGalter_admin_interface</option></select></div>";
