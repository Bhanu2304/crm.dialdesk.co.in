...
if ( ($report_display_type=='HTML') or ($report_display_type=='LIMITED') )
	{
	$Aecho = '';
	$Aecho .= "<table cellpadding=1 cellspacing=1 border=0 class='table table-striped table-bordered datatables' >";
	$Aecho .= "<tr>";
...
#				{$G='<SPAN class="orange"><B>'; $EG='</B></SPAN>';}
		...
		if ( ($report_display_type=='HTML') or ($report_display_type=='LIMITED') )
			...
			if ($filtered_ingroup==1) 
				...
				if ($realtime_block_user_info > 0)
					{
					$Aecho .= "<tr class=''><td >$UGD $G$sessionid$EG$L$R$Aring_note[$i]</td>
					<td align=center>$MO $G"._QXZ("$status",6)."$EG</td>
					<td bgcolor=white align=center><font class='Hblank'>$CM</td>
