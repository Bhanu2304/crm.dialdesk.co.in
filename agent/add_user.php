                ...
                <div class="card" data-widget='{"draggable": "false"}'>
                    ...
                    <div class="card-body">
                        ...
                        <form action="add_user.php" method="post">
                          ...
                          <div class="row">
                              <?php if ($voi_count > 0){
                                  echo "<label class='col-sm-1 control-label'>User Number</label>";
                                  echo "<div class='col-sm-3'><input type=hidden name=user id=user value='99999'></div>";
                                  echo "<div class='col-sm-8'></div>";
                              }
                              else{

                                  echo "<label class='col-sm-1 control-label'>User Id</label>";
                                  echo "<div class='col-sm-3'><input type=text class='form-control' placeholder='User Id' required name=user id=user maxlength=20> </div>";
                                  echo "<label class='col-sm-1 control-label'>&nbsp;</label>";
                                  echo "<div class='col-sm-3'> <input class='fc fc-button btn-info' type=button name=auto_user value='AUTO-GENERATE' onClick='user_auto()'></div>";
                          ...
                          <div class='row'>
                              ...
                              <div class='col-sm-3'><input type=text class='form-control' placeholder=Password required id=reg_pass name=pass  maxlength=100 onkeyup=\"return pwdChanged('reg_pass','reg_pass_img');\"></div>

                              <label class='col-sm-1 control-label'>Name</label>
                              <div class='col-sm-3'><input type=text class='form-control' placeholder='Full Name' required  name=full_name  maxlength=100></div>
                          ...
                          <div class='row'>
                              ...
                              <label class='col-sm-1 control-label'>Phone Login</label>
                              <div class='col-sm-3'><input type=text class='form-control' placeholder='Phone Login' required  name=phone_login  maxlength=20></div>

                              <label class='col-sm-1 control-label'>Phone Pass</label>
                              <div class='col-sm-3'><input type=text class='form-control' placeholder='Phone Pass' required  name=phone_pass  maxlength=20></div>
                          </div>
                          <br>
                          <div class='row'>
