...
echo "<TITLE>$report_name: $group</TITLE></HEAD><BODY  marginheight=0 marginwidth=0 leftmargin=0 topmargin=0 class='animated-content infobar-overlay sidebar-scroll' >\n";
	...
	require("admin_header.php");
        ?>
        <ol class="breadcrumb">                              
            <li><a href="<?php echo $base_url;?>admin.php">Home</a></li>
            <li><a href="#">Agent Reports</a></li>
            <li class="active"><a href="#">Real-Time Main Report</a></li>
            <li><a href="#" onclick="return  window.history.back()" >Back</a></li>
        </ol>
...
echo "<TABLE WIDTH=" . $webphone_bufw . " CELLPADDING=" . $webphone_pad . " CELLSPACING=0 ><TR><TD ALIGN=LEFT>\n";
