...
$(document).ready(function() {
      ...
      function refreshDiv() {
        ...
        $.get("check_call.php", function(data) {
          ...
          $("#dataout").html(response.table_data);
          //$("#calleridx").html(response.calleridx); 
          if (response.dynamic_form && response.dynamic_form.trim() !== "") {
              $("#dynamic_form_ib").html(response.dynamic_form);
              //console.log("test");
              refreshInterval = 60000;
              //setTimeout(refreshDiv, 120000);
          }else{
            $("#dynamic_form_ib").html('');
        ...
        refreshTimer = setTimeout(refreshDiv, refreshInterval);
      }
      ...
      <div class="page-wrapper">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <div class="col-md-3" id="myDIV" style="display:none">
                    <div class="card">
                            ...
                            <form action="" method="post">
                              <div class="row">
                                <div class='col-sm-12'>
                                  ...
                                  <select class='form-control' size='1' name='status' id='status'>
                                    <option value="Select Group">Select Group</option>
                                    <?php 
                                    foreach($Ingroups as $v)
                                    {
                                    ?>
                                    <option value="<?php echo $v;?>"><?php echo $v;?></option>
                                    <?php } ?>  
                                  </select>
                                  <input class='btn btn-primary' type="button" name="GroupTnf" value="Group Transfer">
                                </div>
                                
                                <div class='col-sm-12'>
                                  <label>Transfer Number</label>
                                  <input type="text" class="form-control" name="tranf_nnumber" id="tranf_nnumber" autocomplete="off" value="">
                                  <input class='btn btn-primary' type=button name=BlindTrnf value='Blind Trannsfer'>
                                </div>
